...
import { fileApi, dictionaryApi, recordApi } from '../../services/api';
import { OutLineButton } from '../../components/outline_button';
import { log } from '../../helpers/log';
import ModalUpload from './components/modal_upload';
...
export const Recorder = () => {
    ...
    const handleUploadFile = async (data) => {
        try {
            const realData = { ...formData, ...data };

            await recordApi.uploadOneFile(realData);
    ...
    return (
        <>
            ...
            <ModalUpload
                ...
                onSave={(data) => handleUploadFile(data)}
            />
        </>
    )
}